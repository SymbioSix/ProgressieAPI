...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/quiz-answer-multiple-choices": {
            "post": {
                ...
                "tags": [
                    "QuizAnswerMultipleChoice Service"
                ],
                "summary": "Create a new QuizAnswerMultipleChoice",
                "parameters": [
                    {
                        "description": "QuizAnswerMultipleChoice Object",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/quiz-answer-multiple-choices/{id}": {
            "get": {
        ...
        "/quiz-questions/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated QuizQuestion data",
                        "name": "quizQuestion",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/quiz-results/{quiz_id}/{user_id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated QuizResult Data",
                        "name": "quizResult",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "models.QuizAnswerMultipleChoice": {
            "type": "object",
            "properties": {
                "answer": {
                    "type": "string"
                ...
                "status": {
                    "$ref": "#/definitions/models.MultCheckBoxStatus"
                },
                "updated_at": {
                    "type": "string"
                },
        ...
        "models.QuizQuestion": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/models.QuizQuestionStatus"
                },
                "updated_at": {
                    "type": "string"
                },
        ...
        "models.QuizResult": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/models.QuizResultStatus"
                },
                "updated_at": {
                    "type": "string"
                },
